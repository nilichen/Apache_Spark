...
dayHostCount = dayGroupedHosts.mapValues(lambda x: len(x))
...
sortedByDay = groupedByDay.sortByKey(1, 1)

avgDailyReqPerHost = (sortedByDay
                      .mapValues(lambda x: len(x)/len(set(x)))
                      .cache())
...
badEndpointsTop20 = badEndpointsSum.top(20, lambda s: s[1])
...
topErrDate = errDateSorted.top(5, lambda s: s[1])
